        ...
        <div className="max-sm:max-w-[30rem] sm:max-md:w-[38rem] md:max-lg:w-[44rem] lg:max-w-2xl mx-40 mt-12 overflow-hidden bg-gray-800 rounded-lg shadow-md dark:bg-white">
            ...
            <div className="p-6">
                <div>
                    ...
                    <Link to="https://shimmering-souffle-b43c04.netlify.app/" className="block mt-2 text-xl font-semibold text-white transition-colors duration-300 transform dark:text-neutral-800 font-Marker hover:underline" tabindex="0">Batman landing page</Link>
                ...
                <div className="mt-4">
                    <div className="flex items-center">
                        ...
                        <span className="mx-1 text-xs text-white/80 font-Kalam dark:text-neutral-800">Jun 27, 2023</span>
                        <span className="mx-2">
                            <Link to="https://github.com/Rakotozonirina/SAYNA-JAVASCRIPT-BATMAN2" target="_blank">
